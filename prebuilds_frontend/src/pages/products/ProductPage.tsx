...
const ProductPage = () => {
  ...
  const showCartModal = (value: boolean) => {
    setCartModal(value);
  };
  ...
  return (
    <>
      <div className="mx-auto px-4 py-8  ">
            ...
            <div className="md:w-1/2 relative">
              {product?.product_picture ? (
                <>
                  ...
                  <div className="absolute top-2 left-2 text-gray-800 dark:text-white text-xl font-bold px-2 py-1 rounded">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">You Might Also Like {"<PlaceHolder>"} </h2>
