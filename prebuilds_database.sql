...
CREATE TABLE `global_settings` (
  ...
  PRIMARY KEY (`new_product_duration`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `global_settings` VALUES (1441);
...
INSERT INTO `personal_access_tokens` VALUES (36,'App\\Models\\Users',3,'prebuilds_auth-token','08406095619484aeb846ee122f14362fb76b67f5f7cea4ead15159f3a9c99b31','[\"Client\",3]','2025-03-22 10:04:49',NULL,'2025-03-22 05:25:50','2025-03-22 10:04:49'),(40,'App\\Models\\Users',1,'prebuilds_auth-token','022761f4a0157c50a7b4225ffcf17d7de704bf3615651adc74c3695bfa684b4b','[\"Owner\",1]','2025-03-22 10:09:12',NULL,'2025-03-22 10:09:11','2025-03-22 10:09:12');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER resetCartQuantity
...
INSERT INTO `shopping_cart` VALUES (22,1,79,1),(23,1,82,1),(24,1,90,1);
...
INSERT INTO `users` VALUES (1,'yem0417','Yem','EL MOUMEN','0636523432','Morocco','BernoussiBernoussiBernoussiBernoussiBernoussiBernoussi','dinactiprefected@gmail.com','$2y$12$RIL7Ghy6YUYwbvJ0esQ.FO6.O70eeGCiAJf/KQYngieLOcw4JWanK','Owner','Unlocked','2024-12-26 00:20:34','2025-03-22 10:09:11'),(2,'Admin','Admin','Aura','The G','Morocco','TestingTesting','ee@gmail.com','$2y$12$mTo3vuX6SBvB0HZDVyrps.Og2JycZtOjR4RlXS87h6RB9U3AEFdDu','Admin','Unlocked','2024-12-26 01:27:47','2025-03-22 10:08:23'),(3,'Client','Client','yte',NULL,'Antigua and Barbuda',NULL,'dinacte@gmail.com','$2y$12$ePrtVnoM4EJY6Tua3PgDB.IJgGLYQnovgyZelsZPsm2/uNlcaF93C','Client','Unlocked','2025-01-18 22:52:21','2025-03-22 05:25:50');
...
-- Dump completed on 2025-03-22 10:21:18
